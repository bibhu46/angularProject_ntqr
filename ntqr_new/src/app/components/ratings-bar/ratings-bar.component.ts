...
export class RatingsBarComponent implements OnInit {
  ...
  @Input() display_value?: number = 0;
  @Input() show_display?: boolean = false;
  ...
  ngOnInit(): void {
    ...
    if(this.bar_color !== undefined || this.bar_color !== ''){
      ...
      else if(this.bar_color == 'blue'){
        this.status_red = false;
        this.status_green = false;
        this.status_blue = true;
      }
    } 
