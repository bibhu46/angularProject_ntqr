...
export class CallAttemptsV2ComponentV20 implements OnInit {
  ...
  ngOnInit(): void {
    this.titleService.setTitle('NGIN 20 Call Attempts'); 
  ...
  showPopUpHistory(date: string) {
    let url = appConfig.hostUrl+"ngin20/callAttemptsPopup/"+date;
