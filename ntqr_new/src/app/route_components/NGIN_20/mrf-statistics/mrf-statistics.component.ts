...
export class MrfStatisticsComponentV20 implements OnInit {
  ...
  ngOnInit(): void {
    this.titleService.setTitle('NGIN 20 MRF Statistics'); 
  ...
  showPopUpHistory(date, host) {
    ...
    let url = appConfig.hostUrl + "ngin20/mrfStatisticsPopup/" + this.date + "/" + host;
