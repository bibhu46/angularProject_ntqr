...
export class SystemStatComponentV20 implements OnInit {
...
public loader:boolean
  ...
  ngOnInit(): void {
    this.titleService.setTitle('NGIN 20 System Statistics');
  ...
  showPopUpHistory(date:string, host:string){
    ...
    let url = appConfig.hostUrl+"ngin20/systemStatisticsPopup/"+this.date+"/"+host;
