...
export class ExpandInstallednumberCountryComponentV20 implements OnInit {
  public response: any
  ...
  showPopUpHistory() {
    let url = "http://localhost:4200/"+"ngin20/installedNumbersPopup/"+this.countryId+"/"+this.desc+"/"+this.name+"/"+this.date;
