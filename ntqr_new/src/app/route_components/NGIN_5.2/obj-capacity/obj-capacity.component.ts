...
export class ObjCapacityComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.titleService.setTitle('NGIN 5.2 Object Capacity'); 
  ...
  showPopUpHistory(serviceId:string, desc:string, servName:string){
    ...
    //this.servNamen=servName.substring(2,servName.length)
     ...
     let url = appConfig.hostUrl+"ngin5.2/objectCapacityPopup/"+serviceId+"/"+descNeww+"/"+servName+"/"+this.date;
